...
//    private Map<Attribute, String> environmentAttributes; // This a map between an env attribute and its matching function in XACML rule
    ...
    public PolicyRule(Map<String, List<Map<Attribute,String>>> resourceAttributeMap,
                      ...
                      ResourceBase resourceBase, ActionBase actionBase) throws Exception {
        ...
        // extract the implied permissions from the policy rule when it is created, instead of performing this online
        extractPermissionsFromRule(resourceBase,actionBase);
    }
...
//                String attributeMatchingFunction = attributeMatchingFunctionEntry.getValue();
    ...
    public List<Permission> getPermissionsFromRule()
    {
        return permissionList;
    }

    private void extractPermissionsFromRule(ResourceBase resourceBase, ActionBase actionBase) throws Exception
    {
//        Date date = new Date();
        ...
        //System.out.println("Time for getPermissionsFromRule() is:" +(new Date().getTime() - date.getTime()));
    }
}
